        ...
        t.prototype.init = function () {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (themeMode === "light") {
                    ...
                    t.$appStylesheet.attr("href", t.$originalAppStylesheet);
                    e("#light-mode-switch").prop("checked", !0);
                    e("#dark-mode-switch").prop("checked", !1);
                } else if (themeMode === "dark") {
                    t.$bootstrapStylesheet.attr("href", e("#dark-mode-switch").data("bsstyle"));
                    t.$appStylesheet.attr("href", e("#dark-mode-switch").data("appstyle"));
                    e("#dark-mode-switch").prop("checked", !0);
                    e("#light-mode-switch").prop("checked", !1);
                }
            });
        }
