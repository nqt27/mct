...
class MenuDichVu extends Model
{
    ...
    {
        return $this->hasMany(MenuDichVu::class, 'parent_id');
    }
    ...
    {
        return $this->belongsTo(MenuDichVu::class, 'parent_id');
    }
