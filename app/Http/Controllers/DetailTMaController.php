...
class DetailTMaController extends Controller
{
    public function index()
    {
        ...
        return view('detailTMa', ['logo' => $logo, 'hot_audio' => $hot_audio, 'new_audio' => $new_audio, 'menu' => $menu, 'dichvu' => $dichvu, 'slide' => $slide]);
    }
