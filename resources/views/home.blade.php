        ...
        <div class="carousel-container">
            <div class="carousel">
                ...
                <div class="card" data-flipped="false">
                    <div class="front" style="background-image: url('{{asset('uploads/images/'. $s->filename)}}');"></div>
    ...
    <section class="snake-content">
        ...
        <div class="content-left-item post">
            ...
            <div class="content-left-item-content">
                @foreach($dichvu as $n)
                <div class="card">
                    <img src="{{ asset('uploads/images/' . $n->image) }}" class="card-img-top" alt="{{ $n->title }}">
                    <div class="card-body">
                        <div class="noidung-dichvu">
                            <h5 class="card-title">{{ $n->tieude }}</h5>
                            <p class="card-text">{!! Str::limit($n->noidung, 100) !!}</p>
                        </div>
                        <a href="{{ route('detail', $n->slug) }}" class="btn btn-primary vertical-button">Xem chi tiết</a>
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="info">
                <figure class="snip1156">
                    ...
                    <figcaption>
                        ...
                        <div>
                            <p>Phim doanh nghiệp – Sản xuất MV – Video Quảng cáo – Video Viral – Video Marketing chất lượng cho mọi nhu cầu của Dự án hợp với MCT Media.
                            </p>
                        </div>
                    </figcaption>
                    <a href="#"></a>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function updateCarousel() {
            cards.forEach((card, index) => {
                ...
                card.style.transform = `translateX(${xOffset}px) scale(${scale}) rotateY(${isFlipped ? 180 : 0}deg)`;
