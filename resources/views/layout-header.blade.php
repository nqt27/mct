...
<body>
    <header class="snake-top-view">
        ...
        <article class="snake-navigation">
            <nav class="main-menu">
                <ul class="snake-menu">
                    <li class="active  menu-item" par="1"><a href="#"><i class="fa-solid fa-house-chimney"></i></a></li>
                    <li class="menu-item drop" par="3">
                        ...
                        <ul class="sub-menu sub-menu-1" par="1">
                            @foreach($menu as $m)
                            <li class="menu-item2 drop" par="4"><a href="{{$m->url}}">{{$m->ten}}</a>
                                <ul class="sub-menu2 sub-menu-1">
                                    @foreach($m->submenu as $sm)
                                    <li class="menu-item" par="4"><a href="{{$m->url}}">{{$sm->ten}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            @endforeach
                    ...
                    <li class="menu-item" par="17"><a href="">Blog</a></li>
