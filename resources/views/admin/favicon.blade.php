            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Thay đổi Favicon</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-md-12">
                    <div class="card card-border-color card-border-color-primary">
                        <div class="card-header card-header-divider">
                            <button class="btn btn-primary waves-effect waves-light" type="submit" id="submit"><i class="fas fa-save mr-1"></i><span>Lưu favicon</span></button>
                            <a href="{{route('admin')}}" class="btn btn-secondary waves-effect waves-light" type="button"><span>Trở về</span></a>
                            <!-- <button class="btn btn-space btn-primary" style="float: right;" type="submit" id="submit">Lưu favicon</button>
                            <button class="btn btn-space btn-secondary" style="float: right;">Hủy</button> -->
                        </div>
                        <div class="card-body" style="display:flex; flex-direction:column; align-items: center;">
                            <div id="custom-preview" class="custom-preview preview-favicon" style="margin: 20px">
                                <!-- Các ảnh preview sẽ hiển thị ở đây -->
                            </div>
                            <form style="max-width: 100%" method="post" action="{{route('favicon.store')}}" enctype="multipart/form-data" class="dropzone dz-clickable col-sm-9" id="my-dropzone">
                                @csrf
...
<script>
    ...
    $(document).ready(function() {
        ...
        var myDropzone = new Dropzone("#my-dropzone", {
            ...
            paramName: "favicon", // Tên trường khi gửi lên server
        ...
        $('#submit').on('click', function(e) {
            ...
            $.ajax({
                url: '/admin/favicon', // Đường dẫn route
                method: 'POST',
                data: formData,
