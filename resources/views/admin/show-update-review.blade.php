            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="card card-border-color card-border-color-primary">
                        ...
                        <div class="card-body">
                            <form style="width: 100%;" id="audio-info-form" method="post" action="{{ route('review.update', $review->id) }}">
                                @csrf
                    ...
                    <div class="card card-border-color card-border-color-primary">
                        ...
                        <div class="card-body">
                            <form style="width: 100%;" id="audio-seo-form" method="post" action="{{ route('review.store') }}">
                                @csrf
                                <div class="form-group row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="card card-border-color card-border-color-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form style="max-width: 100%" method="post" action="{{route('review.store')}}" enctype="multipart/form-data" class="dropzone dz-clickable col-sm-9" id="my-dropzone">
                                @csrf
