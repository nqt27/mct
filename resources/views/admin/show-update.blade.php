        ...
        <div class="main-content container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Chỉnh sửa thông tin Audio</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="card card-border-color card-border-color-primary">
                        <div class="card-header bg-info">
                            <h3 class="card-title text-white mb-0">Thông tin Audio</h3>
                        </div>
                        <div class="card-body">
                            <form style="width: 100%;" id="audio-info-form" method="post" action="{{ route('audio.update', $audio->id) }}">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label">Đường dẫn mẫu</label>
                                    <div class="col-sm-9">
                                        <p class="form-control-static" id="url-simple">{{$audio->slug}}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 control-label"></label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" required="" placeholder="Đường dẫn" value="{{$audio->slug}}" name="slug" id="audio-url">
                                    </div>
                                </div>
                                <div class=" form-group row">
                                    <label class="col-md-3 control-label">Tên Audio</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" required="" placeholder="Tên Audio" value="{{$audio->ten}}" name="ten" id="name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class=" form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" required="" placeholder="Tác giả" value="{{$audio->tacgia}}" name="tacgia" id="tacgia">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <form style="width: 100%;" id="audio-seo-form" method="post" action="{{ route('audio.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="Keywword chính" name="keyword_focus" id="keyword_focus" value="{{$audio->keyword_focus}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 control-label">SEO Title:</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="seo_title" name="seo_title" id="seo_title" value="{{$audio->seo_title}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 control-label">SEO Keywords:</label>
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" placeholder="seo_keywords" name="seo_keywords" value="{{$audio->seo_keywords}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 control-label">SEO Description:</label>
                                    <div class="col-sm-9">
                                        <textarea name="seo_description" style="width: 100%; height: 120px; padding: 10px;" id="seo_description" placeholder="SEO Description">{{$audio->seo_keywords}}</textarea>
                                    </div>
                                </div>
                ...
                <div class="col-md-5">
                    <div class="card card-border-color card-border-color-primary">
                        ...
                        <div class="card-body" id="audio-status-form">
                            <div class="form-group" style="justify-content: space-between; align-items: center;">
                                ...
                                <div style="padding: 0" class="col-12 col-sm-8 col-lg-6">
                                    <div class="switch-button switch-button-success switch-button-xs">
                                        <input type="checkbox" class="status-checkbox" data-switch="success" {{ $audio->display ? 'checked' : '' }} name="display" id="display{{$audio->id}}">
                                        <label for="display{{$audio->id}}" data-on-label="Yes" data-off-label="No"></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="justify-content: space-between; align-items: center;">
                                ...
                                <div style="padding: 0" class="col-12 col-sm-8 col-lg-6">
                                    <div class="switch-button switch-button-success switch-button-xs">
                                        <input type="checkbox" class="status-checkbox" data-switch="success" {{ $audio->nghenhieu ? 'checked' : '' }} name="nghenhieu" id="hot{{$audio->id}}">
                                        <label for="display{{$audio->id}}" data-on-label="Yes" data-off-label="No"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" style="justify-content: space-between; align-items: center;">
                                ...
                                <div style="padding: 0" class="col-12 col-sm-8 col-lg-6">
                                    <div class="switch-button switch-button-success switch-button-xs">
                                        <input type="checkbox" class="status-checkbox" data-switch="success" {{ $audio->moi ? 'checked' : '' }} name="moi" id="is_new{{$audio->id}}">
                                        <label for="is_new{{$audio->id}}" data-on-label="Yes" data-off-label="No"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-border-color card-border-color-primary">
                        <div class="card-header bg-info">
                            <h3 class="card-title text-white mb-0">Hình ảnh đại diện</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card card-border-color card-border-color-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form style="max-width: 100%" method="post" action="{{route('audio.store')}}" enctype="multipart/form-data" class="dropzone dz-clickable col-sm-9" id="my-dropzone1">
                                @csrf
                                <div class="dz-message">
                                    <div class="icon"><span class="mdi mdi-cloud-upload"></span></div>
                                    <h4>Kéo thả hình vào đây</h4>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#submit-all').on('click', function(e) {
            ...
            var audioId = "{{ $audio->id }}"; // Lấy ID sản phẩm từ PHP
            //Gửi request AJAX với FormData đã gộp
            $.ajax({
                url: `/admin/audio/${audioId}`, // Đường dẫn route
                method: 'POST',
                data: formData,
