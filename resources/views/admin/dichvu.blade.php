                ...
                <div class="col-sm-12">
                    <div class="card card-table">
                        <div class="card-header">
                            <a href="{{route('dichvu.add')}}" class="btn btn-space btn-primary" id="btn-add-audio"><i class="icon icon-left mdi mdi-plus-circle"></i><span>Thêm mới</span></a>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX a">
                                        ...
                                        <td class="center col-1">
                                            <div class="row">
                                                <div class="col-12">
                                                    <a href="/admin/dichvu-detail/{{$n->id}}" class="btn btn-space btn-info" id="btn-add-audio" style="width: 100%;margin: 5px;"><i class="fas fa-edit mr-1"></i><span>Chỉnh sửa</span></a>
                                                </div>
                                                <div class="col-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        statusAudio('/admin/dichvu-status/');
        deleteItem('/admin/dichvu/');
        deleteAll('/admin/delete-all-dichvu');
    });
</script>
</body>
